...
export const projectsData = {
  "projects": [
    ...
    },
    {
      ...
      "projectOverview": "MobiFlow transforms urban mobility by integrating all transportation modes into a single, intelligent platform. Users benefit from real-time route optimization, unified payments, and comprehensive trip management. The platform encourages sustainable transportation choices while providing drivers and mobility partners with tools to maximize efficiency and earnings. Our vision is to make cities more connected, accessible, and environmentally conscious.",
      "sections": [
        {
          "id": 1,
    ...
    },
    {
      ...
      "projectOverview": "TravelMate simplifies travel planning by combining personalized AI recommendations, comprehensive booking capabilities, and intelligent expense management. From discovering hidden local gems to comparing flights and accommodations, the platform handles every aspect of trip planning. Advanced algorithms learn user preferences to provide increasingly tailored suggestions, while collaborative features help travel groups stay organized and manage shared costs effortlessly.",
      "sections": [
        {
          "id": 1,
    ...
    },
    {
      ...
      "projectOverview": "WellHub creates a comprehensive wellness ecosystem that empowers users to take control of their health. By integrating fitness tracking, personalized nutrition planning, and access to certified wellness coaches, the platform provides holistic support for achieving health goals. Community challenges and social features foster accountability and motivation, while detailed analytics help users understand their progress and make data-driven decisions about their wellbeing.",
      "sections": [
        {
          "id": 1,
        ...
        },
        {
          ...
          "features": [
            ...
            "Macro tracking",
            "Recipe database with substitutions"
          ]
        },
        {
          "id": 3,
