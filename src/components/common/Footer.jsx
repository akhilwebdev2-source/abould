    ...
    <footer className="relative bg-surface-alt pt-20 overflow-hidden">
      ...
      >
        <div className="container mx-auto max-w-7xl">
            ...
            {/* Top Section: CTA */}
            <div className="text-center mb-24 relative z-10 px-70">
               <h2 className="text-4xl md:text-5xl lg:text-5xl font-heading text-primary-dark tracking-tight leading-tight mb-6">
                ...
                <div className="flex flex-col items-center md:items-end gap-6">
                      ...
                      <div className="flex items-center gap-3">
                          {['twitter', 'facebook', 'instagram', 'linkedin'].map((social) => (
                             ...
                             >
                                {/* Icons */}
                                {social === 'twitter' && <Twitter className="w-4 h-4" fill />}
                                {social === 'facebook' && <Facebook className="w-4 h-4" fill />}
                                {social === 'instagram' && <Instagram className="w-4 h-4"  />}
                                {social === 'linkedin' && <Linkedin className="w-4 h-4"fill />}
                             </a> 
                          ))}
                      </div>
